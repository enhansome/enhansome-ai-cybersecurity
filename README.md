...
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,917 | 🐛 258 | 🌐 C++ | 📅 2026-08-29 - A powerful network analysis framework focused on security monitoring. AI can be integrated to analyze network traffic patterns and detect anomalies indicative of security threats.
...
* [OneCLI](https://github.com/onecli/onecli) ⭐ 3,423 | 🐛 131 | 🌐 TypeScript | 📅 2026-08-29 - Open-source credential vault for AI agents. Rust HTTP gateway intercepts agent requests and injects API credentials transparently, preventing key exfiltration via prompt injection.
* [Xquik](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 189 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-27 - Independent X (Twitter) data API for search, follower export, monitors, and MCP.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,651 | 🐛 540 | 🌐 TypeScript | 📅 2026-08-29 - Open-source LLM red teaming and vulnerability scanner. 100+ attack types, 250k+ users.
* [garak](https://github.com/NVIDIA/garak) ⭐ 9,066 | 🐛 408 | 🌐 Python | 📅 2026-08-25 - NVIDIA  LLM vulnerability scanner.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,651 | 🐛 540 | 🌐 TypeScript | 📅 2026-08-29 - Open-source LLM red teaming with adaptive multi-turn attacks, prompt injection, and jailbreak testing.
* [garak](https://github.com/leondz/garak/) ⭐ 9,066 | 🐛 408 | 🌐 Python | 📅 2026-08-25 - A security probing tool for large language models (LLMs).
* [HackingBuddyGPT](https://github.com/ipa-lab/hackingBuddyGPT) ⭐ 1,225 | 🐛 2 | 🌐 Python | 📅 2026-08-28 - An automated penetration tester.
* [HackGPT](https://github.com/NoDataFound/hackGPT) ⭐ 1,202 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-08-12 - A tool leveraging ChatGPT for hacking purposes.
...
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 877 | 🐛 3 | 🌐 Python | 📅 2026-08-25 - An open source engine for autonomous AI penetration testing that orchestrates 80+ offensive tools through Markdown playbooks and agentic reasoning over MCP, with a command and raw output evidence trail for every finding across web, cloud, Active Directory, Kubernetes and API.
...
* [CircleGuardBench](https://github.com/whitecircle-ai/circle-guard-bench) ⭐ 74 | 🐛 1 | 🌐 Python | 📅 2026-03-07 - A full-fledged benchmark for evaluating protection capabilities of AI models.
