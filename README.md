...
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,915 | 🐛 253 | 🌐 C++ | 📅 2026-08-28 - A powerful network analysis framework focused on security monitoring. AI can be integrated to analyze network traffic patterns and detect anomalies indicative of security threats.
...
* [Nikto](https://github.com/sullo/nikto) ⭐ 10,688 | 🐛 1 | 🌐 Perl | 📅 2026-08-18 - An open-source web server scanner which performs comprehensive tests against web servers for multiple items. AI can help Nikto by automating the identification of complex vulnerabilities and enhancing detection accuracy.
...
* [OneCLI](https://github.com/onecli/onecli) ⭐ 3,421 | 🐛 132 | 🌐 TypeScript | 📅 2026-08-28 - Open-source credential vault for AI agents. Rust HTTP gateway intercepts agent requests and injects API credentials transparently, preventing key exfiltration via prompt injection.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,632 | 🐛 533 | 🌐 TypeScript | 📅 2026-08-28 - Open-source LLM red teaming and vulnerability scanner. 100+ attack types, 250k+ users.
* [garak](https://github.com/NVIDIA/garak) ⭐ 9,052 | 🐛 405 | 🌐 Python | 📅 2026-08-25 - NVIDIA  LLM vulnerability scanner.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,632 | 🐛 533 | 🌐 TypeScript | 📅 2026-08-28 - Open-source LLM red teaming with adaptive multi-turn attacks, prompt injection, and jailbreak testing.
* [garak](https://github.com/leondz/garak/) ⭐ 9,052 | 🐛 405 | 🌐 Python | 📅 2026-08-25 - A security probing tool for large language models (LLMs).
* [HackingBuddyGPT](https://github.com/ipa-lab/hackingBuddyGPT) ⭐ 1,224 | 🐛 2 | 🌐 Python | 📅 2026-08-28 - An automated penetration tester.
...
* [Counterfit](https://github.com/Azure/counterfit) ⭐ 937 | 🐛 25 | 🌐 Python | 📅 2025-07-18 - An automation layer for assessing the security of machine learning systems.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 875 | 🐛 2 | 🌐 Python | 📅 2026-08-25 - An open source engine for autonomous AI penetration testing that orchestrates 80+ offensive tools through Markdown playbooks and agentic reasoning over MCP, with a command and raw output evidence trail for every finding across web, cloud, Active Directory, Kubernetes and API.
...
* [ProtectAI's model scanner](https://github.com/protectai/model-scanner) ⭐ 765 | 🐛 80 | 🌐 Python | 📅 2026-02-18 - A security scanner for detecting suspicious actions in serialized ML models.
