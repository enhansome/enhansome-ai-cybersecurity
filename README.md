...
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,965 | 🐛 257 | 🌐 C++ | 📅 2026-09-16 - A powerful network analysis framework focused on security monitoring. AI can be integrated to analyze network traffic patterns and detect anomalies indicative of security threats.
...
* [Cortex](https://github.com/TheHive-Project/Cortex) ⭐ 1,627 | 🐛 175 | 🌐 Scala | 📅 2026-06-30 - A powerful and flexible observable analysis and active response engine. AI can be used in Cortex to automate the analysis of observables and enhance threat detection capabilities.
...
* [Nikto](https://github.com/sullo/nikto) ⭐ 10,728 | 🐛 1 | 🌐 Perl | 📅 2026-09-15 - An open-source web server scanner which performs comprehensive tests against web servers for multiple items. AI can help Nikto by automating the identification of complex vulnerabilities and enhancing detection accuracy.
...
* [OneCLI](https://github.com/onecli/onecli) ⭐ 3,484 | 🐛 150 | 🌐 TypeScript | 📅 2026-09-14 - Open-source credential vault for AI agents. Rust HTTP gateway intercepts agent requests and injects API credentials transparently, preventing key exfiltration via prompt injection.
* [Xquik](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 199 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-04 - Independent X (Twitter) data API for search, follower export, monitors, and MCP.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,147 | 🐛 647 | 🌐 TypeScript | 📅 2026-09-16 - Open-source LLM red teaming and vulnerability scanner. 100+ attack types, 250k+ users.
* [garak](https://github.com/NVIDIA/garak) ⭐ 9,259 | 🐛 434 | 🌐 Python | 📅 2026-09-09 - NVIDIA  LLM vulnerability scanner.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,147 | 🐛 647 | 🌐 TypeScript | 📅 2026-09-16 - Open-source LLM red teaming with adaptive multi-turn attacks, prompt injection, and jailbreak testing.
* [garak](https://github.com/leondz/garak/) ⭐ 9,259 | 🐛 434 | 🌐 Python | 📅 2026-09-09 - A security probing tool for large language models (LLMs).
* [HackingBuddyGPT](https://github.com/ipa-lab/hackingBuddyGPT) ⭐ 1,239 | 🐛 2 | 🌐 Python | 📅 2026-09-13 - An automated penetration tester.
* [HackGPT](https://github.com/NoDataFound/hackGPT) ⭐ 1,205 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-08-12 - A tool leveraging ChatGPT for hacking purposes.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 940 | 🐛 2 | 🌐 Python | 📅 2026-09-08 - An open source engine for autonomous AI penetration testing that orchestrates 80+ offensive tools through Markdown playbooks and agentic reasoning over MCP, with a command and raw output evidence trail for every finding across web, cloud, Active Directory, Kubernetes and API.
* [Counterfit](https://github.com/Azure/counterfit) ⭐ 939 | 🐛 26 | 🌐 Python | 📅 2025-07-18 - An automation layer for assessing the security of machine learning systems.
...
* [BugTraceAI](https://github.com/BugTraceAI/BugTraceAI) ⭐ 307 | 🐛 2 | 📅 2026-09-14 - Open-source multi-agent platform for authorized web application security testing with validation, evidence capture, and reporting.
...
* [EasyEdit](https://github.com/zjunlp/EasyEdit) ⭐ 2,919 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-07-14 - A tool to modify the ground truths of large language models (LLMs).
...
* [CircleGuardBench](https://github.com/whitecircle-ai/circle-guard-bench) ⭐ 76 | 🐛 3 | 🌐 Python | 📅 2026-03-07 - A full-fledged benchmark for evaluating protection capabilities of AI models.
