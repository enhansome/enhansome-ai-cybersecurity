...
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,988 | 🐛 244 | 🌐 C++ | 📅 2026-09-22 - A powerful network analysis framework focused on security monitoring. AI can be integrated to analyze network traffic patterns and detect anomalies indicative of security threats.
...
* [Cortex](https://github.com/TheHive-Project/Cortex) ⭐ 1,630 | 🐛 175 | 🌐 Scala | 📅 2026-06-30 - A powerful and flexible observable analysis and active response engine. AI can be used in Cortex to automate the analysis of observables and enhance threat detection capabilities.
...
* [Nikto](https://github.com/sullo/nikto) ⭐ 10,738 | 🐛 1 | 🌐 Perl | 📅 2026-09-22 - An open-source web server scanner which performs comprehensive tests against web servers for multiple items. AI can help Nikto by automating the identification of complex vulnerabilities and enhancing detection accuracy.
...
* [OneCLI](https://github.com/onecli/onecli) ⭐ 3,508 | 🐛 160 | 🌐 TypeScript | 📅 2026-09-14 - Open-source credential vault for AI agents. Rust HTTP gateway intercepts agent requests and injects API credentials transparently, preventing key exfiltration via prompt injection.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,375 | 🐛 632 | 🌐 TypeScript | 📅 2026-09-22 - Open-source LLM red teaming and vulnerability scanner. 100+ attack types, 250k+ users.
* [garak](https://github.com/NVIDIA/garak) ⭐ 9,332 | 🐛 458 | 🌐 Python | 📅 2026-09-16 - NVIDIA  LLM vulnerability scanner.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 25,375 | 🐛 632 | 🌐 TypeScript | 📅 2026-09-22 - Open-source LLM red teaming with adaptive multi-turn attacks, prompt injection, and jailbreak testing.
* [garak](https://github.com/leondz/garak/) ⭐ 9,332 | 🐛 458 | 🌐 Python | 📅 2026-09-16 - A security probing tool for large language models (LLMs).
* [HackingBuddyGPT](https://github.com/ipa-lab/hackingBuddyGPT) ⭐ 1,244 | 🐛 2 | 🌐 Python | 📅 2026-09-13 - An automated penetration tester.
* [HackGPT](https://github.com/NoDataFound/hackGPT) ⭐ 1,212 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-08-12 - A tool leveraging ChatGPT for hacking purposes.
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 963 | 🐛 3 | 🌐 Python | 📅 2026-09-21 - An open source engine for autonomous AI penetration testing that orchestrates 80+ offensive tools through Markdown playbooks and agentic reasoning over MCP, with a command and raw output evidence trail for every finding across web, cloud, Active Directory, Kubernetes and API.
...
* [BugTraceAI](https://github.com/BugTraceAI/BugTraceAI) ⭐ 308 | 🐛 2 | 📅 2026-09-22 - Open-source multi-agent platform for authorized web application security testing with validation, evidence capture, and reporting.
...
* [EasyEdit](https://github.com/zjunlp/EasyEdit) ⭐ 2,925 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-07-14 - A tool to modify the ground truths of large language models (LLMs).
...
* [langkit](https://github.com/whylabs/langkit) ⭐ 997 | 🐛 38 | 🌐 Jupyter Notebook | 📅 2024-11-22 - A toolkit for monitoring language models and detecting attacks.
* [ProtectAI's model scanner](https://github.com/protectai/model-scanner) ⭐ 775 | 🐛 82 | 🌐 Python | 📅 2026-02-18 - A security scanner for detecting suspicious actions in serialized ML models.
