...
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,943 | 🐛 255 | 🌐 C++ | 📅 2026-09-04 - A powerful network analysis framework focused on security monitoring. AI can be integrated to analyze network traffic patterns and detect anomalies indicative of security threats.
...
* [Cortex](https://github.com/TheHive-Project/Cortex) ⭐ 1,622 | 🐛 175 | 🌐 Scala | 📅 2026-06-30 - A powerful and flexible observable analysis and active response engine. AI can be used in Cortex to automate the analysis of observables and enhance threat detection capabilities.
...
* [Nikto](https://github.com/sullo/nikto) ⭐ 10,714 | 🐛 1 | 🌐 Perl | 📅 2026-09-07 - An open-source web server scanner which performs comprehensive tests against web servers for multiple items. AI can help Nikto by automating the identification of complex vulnerabilities and enhancing detection accuracy.
...
* [OneCLI](https://github.com/onecli/onecli) ⭐ 3,450 | 🐛 139 | 🌐 TypeScript | 📅 2026-09-03 - Open-source credential vault for AI agents. Rust HTTP gateway intercepts agent requests and injects API credentials transparently, preventing key exfiltration via prompt injection.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,866 | 🐛 590 | 🌐 TypeScript | 📅 2026-09-07 - Open-source LLM red teaming and vulnerability scanner. 100+ attack types, 250k+ users.
* [garak](https://github.com/NVIDIA/garak) ⭐ 9,127 | 🐛 417 | 🌐 Python | 📅 2026-09-04 - NVIDIA  LLM vulnerability scanner.
...
* [promptfoo](https://github.com/promptfoo/promptfoo) ⭐ 24,866 | 🐛 590 | 🌐 TypeScript | 📅 2026-09-07 - Open-source LLM red teaming with adaptive multi-turn attacks, prompt injection, and jailbreak testing.
* [garak](https://github.com/leondz/garak/) ⭐ 9,127 | 🐛 417 | 🌐 Python | 📅 2026-09-04 - A security probing tool for large language models (LLMs).
* [HackingBuddyGPT](https://github.com/ipa-lab/hackingBuddyGPT) ⭐ 1,231 | 🐛 3 | 🌐 Python | 📅 2026-08-29 - An automated penetration tester.
...
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 890 | 🐛 3 | 🌐 Python | 📅 2026-09-06 - An open source engine for autonomous AI penetration testing that orchestrates 80+ offensive tools through Markdown playbooks and agentic reasoning over MCP, with a command and raw output evidence trail for every finding across web, cloud, Active Directory, Kubernetes and API.
...
* [ProtectAI's model scanner](https://github.com/protectai/model-scanner) ⭐ 770 | 🐛 80 | 🌐 Python | 📅 2026-02-18 - A security scanner for detecting suspicious actions in serialized ML models.
...
* [TenSEAL](https://github.com/OpenMined/TenSEAL) ⭐ 1,035 | 🐛 136 | 🌐 C++ | 📅 2026-09-06 - A library for performing homomorphic encryption operations on tensors.
